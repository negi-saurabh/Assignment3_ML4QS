...
dataset = pd.read_csv(dataset_path + 'Ass3_result_outliers.csv', index_col=0)
...
imputed_mean_dataset = MisVal.impute_mean(copy.deepcopy(dataset), 'acc_x')
imputed_median_dataset = MisVal.impute_median(copy.deepcopy(dataset), 'acc_x')
imputed_interpolation_dataset = MisVal.impute_interpolate(copy.deepcopy(dataset), 'acc_x')
DataViz.plot_imputed_values(dataset, ['original', 'mean', 'interpolation'], 'acc_x', imputed_mean_dataset['acc_x'], imputed_interpolation_dataset['acc_x'])
