...
original_dataset = pd.read_csv(dataset_path + 'initial_result.csv', index_col=0)
...
DataViz.plot_dataset(dataset, ['acc_', 'gyr_', 'mag_', 'pca_', 'label'], ['like', 'like', 'like','like', 'like'], ['line', 'line', 'line', 'line', 'points'])

# Store the outcome.

dataset.to_csv(dataset_path + 'Ass3_chapter3_result_final.csv')