...
export_tree_path = '../Example_graphs/Ch7_classification/'

try:
    dataset = pd.read_csv(dataset_path + 'Ass3_chapter5_result.csv', index_col=0)
except IOError as e:
...
basic_features = ['acc_phone_x','acc_phone_y','acc_phone_z','gyr_phone_x','gyr_phone_y','gyr_phone_z', 'mag_phone_x','mag_phone_y','mag_phone_z']
...
selected_features = ['acc_phone_z_temp_mean_ws_120', 'mag_phone_y_temp_mean_ws_120', 'gyr_phone_x_temp_std_ws_120', 'acc_phone_z_freq_0.9_Hz_ws_40', 'acc_phone_y_temp_mean_ws_120', 'mag_phone_z_freq_0.3_Hz_ws_40', 'gyr_phone_x_freq_1.5_Hz_ws_40', 'gyr_phone_x_freq_1.7_Hz_ws_40', 'acc_phone_x_freq_0.6_Hz_ws_40', 'gyr_phone_x_freq_0.5_Hz_ws_40']
